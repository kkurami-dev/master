/** VSCode の「出力」で ESLint を選択すると、eslint の実行結果ログを確認できる
 *「[Error - 9:24:52] Calculating config file for ....」 とか出てなければよい。
 eslint をデバッグするときの設定 VSCode settings.json の記載抜粋
 {
   ...
 ...
 # ESLintのeslint.config.js の詳細解説：サンプルコードと各項目の説明
     https://qiita.com/kenogi/items/29ce7937c1d1cc537a77
 
 # ESLintのルールを全部手動で設定するのは大変だからやめておけ
     https://qiita.com/khsk/items/0f200fc3a4a3542efa90#それでもおまえは荒野をめざす
*/
...
const optG = {
  ...
  // ...globals.browser,
  ...globals.jest,
  AudioWorkletGlobalScope: "readonly", // ← スペースを削除！
};
//delete optG["AudioWorkletGlobalScope "];
// console.log("LLL", optG);
