/**
 * 
 * JavaScript, Node.js, React, AWS Lambda を作成する参考に、
 * 自己啓蒙・研究・検証を行う為がてら 時計・カレンダーを最近の流行を無視し不慣れな JavaScript で製造。
 * ブラウザ上のソフト開発の基礎を知るため、こてこての Javascript で外部ライブラリは極力使わずに作成している。
 *
 * 方針
