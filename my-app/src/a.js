...
const onHander1 = useCallback((e) => cb2(e), []);
const onHander2 = useCallback((e) => cb22(), []);
  const Tag3 = () => (
    <div>
      <button onClick={onHander1} type="button" id={cb1 || 3}>
        ログを出すボタン
      </button>
      <button onClick={onHander2} type="button" id={cb1 || 3}>
        文字を出すボタン
      </button>
    </div>
  );
...
const onHander3 = useCallback((e) => cb3(e, v3), []);
const onHander4 = useCallback((e) => cb4(1, 2), []);
const onHander5 = useCallback((e) => cb5(1, 2), []);
const onHander6 = useCallback((e) => <p>これでもよいはず２</p>, []);
const onHander7 = useCallback((e) => <p>これでもよいはず３</p>, []);
const onHander8 = useCallback((e) => <p>これでもよいはず４</p>, []);
  const testdata = (
    <div>
      <Tag2 />
      <Tag3 />
      <button onClick={cb3} />
      <button onClick={onHander3} />
      <button onClick={onHander4} />
      <button onClick={onHander5}>押した時動く</button>
      ...
      />
      <button onClick={onHander6} />
      <button onClick={onHander7} />
      <button onClick={onHander8} />
    </div>
  );
  //return testdata;
  return "";
